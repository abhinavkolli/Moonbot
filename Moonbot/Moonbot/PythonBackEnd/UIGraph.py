...
class UIGraph():
    ...
    def __init__(self, QtApplication, Settings):
        ...
        self.mainWidget.setWindowTitle('Moonbot')
        self.mainWidget.resize(self.MAIN_WINDOW_WIDTH_IN_PX, self.MAIN_WINDOW_HEIGHT_IN_PX)
        self.mainWidget.setWindowIcon(QtGui.QIcon("MoonbotIcon.png"))
    ...
    def initializeRootLayout(self):
        ...
        pixmap = QtGui.QPixmap('MoonbotLogo.png')
    ...
    def initializeGraphWidgets(self):
        ...
        self.plot2 = pg.PlotWidget(title='Moonbot decision indicator (normalized)')
