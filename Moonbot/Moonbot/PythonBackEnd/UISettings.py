...
class UISettings(QtGui.QWidget):
    ...
    def __init__(self, settings):
        ...
        self.setWindowTitle('Moonbot Settings')
...
#             self.checkboxAuthorization.setChecked(False)
    ...
    def BuildWindowLayout(self):
        ...
        self.lblPermissions = QtGui.QLabel("Note: Make sure you enabled the <b>View</b> and <b>Trade</b> permissions when creating your API keys on your Coinbase Pro profile. These permissions are required for Moonbot to operate.")
