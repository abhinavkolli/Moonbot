...
class RadioHoverTrading(QtGui.QRadioButton):
    ...
    def enterEvent(self, QEvent):
        self.lblToolTip.setText("Trading mode: Moonbot trades on live market. It will buy the dips and sell the tops on the current trading pair. Refresh is performed every 10 seconds. Depending on the market, the first trade can be initiated a few minutes or hours after the start. By using this mode, you give Moonbot the control of your account balance.")
...
class SliderHoverRiskLevel(QtGui.QSlider):
    ...
    def enterEvent(self, QEvent):
        self.lblToolTip.setText("Adjust the level of the red dashed line (risk line): Moonbot will not buy if the current price value is above this line. This line is updated with the past hours average price and it is weighted with your setting.")
