...
class Settings(object):
    ...
    def SETT_SaveSettings(self):
        ...
        try:
            pickle.dump(self.settings, open("moonbot.settings", "wb"))
        except BaseException as e:
            self.MessageBoxPopup("Error during write operation of Moonbot settings file. Check that you are running Moonbot from a writable directory.", 0)
    ...
    def SETT_LoadSettings(self):
        ...
        try:
            self.settings = pickle.load(open("moonbot.settings", "rb"))
